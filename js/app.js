...
var getRequest = function(query) {
	...
	$.ajax({
		url:'http(s)://gateway.marvel.com:80/v1/public/characters?name=' + query + '&limit=1&apikey=' + publickey + '&hash=' + md5 + '&ts=' + timestamp,
		dataType: 'json',
		type: 'GET'
	})
	...
	.done(function(result){
		...
		$.ajax({
			url:'http(s)://gateway.marvel.com:80/v1/public/events?characters=' + character + '&limit=100&apikey=' + publickey + '&hash=' + md5 + '&ts=' + timestamp,
			dataType: 'json',
			type: 'GET'
		})
